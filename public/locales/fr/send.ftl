...
# SendCrew is a brand name and should not be localized.
downloadMessage = Votre ami⋅e vous a envoyé un fichier avec SendCrew, un service qui permet d’envoyer des fichiers de façon sécurisée, confidentielle et chiffrée via un lien qui expire automatiquement pour que vos informations ne restent pas en ligne indéfiniment.
...
# SendCrew is a brand name and should not be localized.
sendYourFilesLink = Essayer SendCrew
...
# SendCrew is a brand name and should not be localized.
notSupportedDetail = Malheureusement, ce navigateur ne prend pas en charge les technologies web utilisées par SendCrew. Vous devrez utiliser un autre navigateur. Nous vous recommandons Firefox !
notSupportedLink = Pourquoi mon navigateur n’est-il pas pris en charge ?
notSupportedOutdatedDetail = Malheureusement, cette version de Firefox ne prend pas en charge les technologies web utilisées par SendCrew. Vous devez mettre à jour votre navigateur.
...
javascriptRequired = SendCrew nécessite JavaScript
whyJavascript = Pourquoi SendCrew nécessite-t-il JavaScript ?
