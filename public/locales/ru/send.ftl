...
# SendCrew is a brand name and should not be localized.
downloadMessage = Ваш друг отправил вам файл с помощью SendCrew, сервиса, который позволяет вам делиться файлами, используя безопасные, приватные и зашифрованные ссылки, по истечении срока действия которых ваши файлы не остаются в сети навсегда.
...
# SendCrew is a brand name and should not be localized.
sendYourFilesLink = Попробовать SendCrew
...
# SendCrew is a brand name and should not be localized.
notSupportedDetail = К сожалению, этот браузер не поддерживает веб-технологию, благодаря которой работает SendCrew. Ваш нужно попробовать использовать другой браузер. Мы рекомендуем Firefox!
notSupportedLink = Почему мой браузер не поддерживается?
notSupportedOutdatedDetail = К сожалению, эта версия Firefox не поддерживает веб-технологию, благодаря которой работает SendCrew. Ваш нужно обновить свой браузер.
...
legalNoticeTestPilot = SendCrew в настоящее время является экспериментом лётчика-испытателя, и поэтому подпадает под <a>условия службы</a> и <a>уведомление о приватности</a> лётчика-испытателя. Вы можете узнать больше об этом эксперименте и его сборе данных <a>здесь</a>.
legalNoticeMozilla = Использование сайта SendCrew также подпадает под <a>уведомление о конфиденциальности веб-сайтов</a> и <a>правила использования веб-сайтов</a> Mozilla.
...
javascriptRequired = Для SendCrew необходим JavaScript
whyJavascript = Почему SendCrew требуется JavaScript?
