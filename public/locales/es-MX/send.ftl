...
# SendCrew is a brand name and should not be localized.
downloadMessage = Tu amigo te está enviando un archivo a través de SendCrew, un servicio que te permite compartir archivos con un enlace seguro, privado y encriptado que caduca automáticamente para que tus cosas no sean accesibles en línea de por vida.
...
legalNoticeTestPilot = SendCrew sigue siendo un experimento de Test Pilot y está sujeto a las <a>Condiciones del servicio</a> y al <a>Aviso de privacidad</a> de Test Pilot. Puedes saber más acerca de este experimento y si recolección de datos <a>aquí</a>.
